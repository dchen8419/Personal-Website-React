            ...
            <section className='social-media'>
                <div className='social-media-wrap'>
                    ...
                    <div className='social-icons'>
                        ...
                        <Link className='social-icon-link youtube' to='/' target='_black' aria-label="YouTube">
                            <i className='fab fa-youtube'></i>
                        </Link>
                        <Link className='social-icon-link twitter' to='/' target='_black' aria-label="Twitter">
                            <i className='fab fa-twitter'></i>
                        </Link>
                        <Link className='social-icon-link linkedin' to='/' target='_black' aria-label="LinkedIn">
